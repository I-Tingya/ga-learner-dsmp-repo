...
news.TITLE = news.TITLE.str.lower().str.split()
...
logreg_1 = OneVsRestClassifier(LogisticRegression(random_state=0))
logreg_2  = OneVsRestClassifier(LogisticRegression(random_state=0))
# fit on count vectorizer training data
